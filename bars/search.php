...
<script>
    document.getElementById("searchInput").addEventListener("input", function() {
        var filter, cards, card, title, text, i, titleText, textContent, found;
        filter = this.value.toUpperCase();
        cards = document.getElementsByClassName("card");
        found = false; // Flag to track if any matching result is found
        ...
        // Display a message if no matching results are found
        if (!found && filter.trim() !== "") { // Check if filter is not empty
...
<div id="notFoundMessage" style="display: none; color: red;">
