...
<head>
    ...
    <style>
        ...
        .nav-logout:hover {
            background-color:#00A38C; /* Change background color on hover */
            max-width: 210px;
        ...
        .active-link {
            color: black;
            background-color:#00A38C; /* Change background color on hover */
            max-width: 210px; /* Change active link color */
...
<a href="fav.php" class="nav-link <?php if($currentPage == 'fav.php') echo 'active-link'; ?>">
    <img src="icons/fav.png" alt="Archive Icon">
    <span>Favorite</span>
</a>
<a href="archive.php" class="nav-link <?php if($currentPage == 'archive.php') echo 'active-link'; ?>">
    <img src="icons/archive1.png" alt="Archive Icon">
    <span>Archive</span>
</a>

<a href="trashdash.php" class="nav-link <?php if($currentPage == 'trashdash.php') echo 'active-link'; ?>">
    <img src="icons/trash1.png" alt="Trash Icon">
    <span>Trash</span>
</a>
<!-- Logout link -->
<a href="#" class="nav-logout" onclick="return confirmLogout();">
    <img src="icons/shutdown.png" alt="Logout Icon">
    <span>Logout</span>
</a>
