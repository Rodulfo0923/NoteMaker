...
<body style="background-color: white">
    ...
    <div class="profile-container" box-shadow: 1px 1px 10px white, -1px -1px 10px white; >
        ...
        <div class="profile-details">
            ...
            <br>
            <button class="btn" style="background-color:#00bfa6" onclick="openEditProfileModal()">Edit Profile</button>
        </div>
    </div>
</div>
...
<div id="editProfileModal" class="modal">
  ...
  <div class="modal-infocontent">
    ...
    <form class="edit-profile-form" method="POST" action="update_profile.php">
        ...
        <button class="btn-up" style="background-color:#00bfa6" type="submit">Save </button>
    </form>
  </div>
</div>
